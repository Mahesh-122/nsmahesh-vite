...
import myLocalImage from "./assets/images/gencare.png";
import myLocalImage1 from "./assets/images/gencare1.png";
import vexaimg from "./assets/images/vexa.png";
...
const greeting = {
  ...
  roles: ["Frontend Developer", "Programmer", "UI/UX Designer"],
  subTitle:
...
const socialMediaLinks = {
  github: "https://github.com/Mahesh-122",
  ...
  whatsapp: "https://api.whatsapp.com/send?phone=919663054850",
...
const skills = [
  ...
  },
  {
    ...
    skills: [
      ...
      {
        name: "Figma",
        image: "https://www.svgrepo.com/show/303210/figma-1-logo.svg"
      }
    ]
  }
];
...
const projects = [
  ...
  },
  {
    ...
    description:
      "Oceanaria is the website project, a website that helps users and teams stay organized and on track. Implemented key features such as task tracking, team collaboration, and time tracking to improve productivity and project outcomes. The plan is to add a community of users where they can find developers and other team members and chat system implementation.",
